...
function plan_with_cone_sensing(
    ...
    while current_state[3] > 0
        ...
        elseif planner_cfg.mode == PlannerGreedyTarget
            ...
            target = select_target_greedy(planner_cfg.greedy, snap, risk_cfg, reachable)
...
#    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k0_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k0_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k0_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k0_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k0_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#
#    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k2_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k2_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k2_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k2_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k2_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#
#    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k4_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k4_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k4_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k4_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k4_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#
#    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k7_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k7_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k7_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k7_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k7_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#
#    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k15_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k15_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k15_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k15_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_CVaR_alpha$(name)_test0_k15_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskCVaR, alpha=alpha), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget)) # PlannerVI, PlannerGreedyTarget)
#
#end
#
...
for (strat, name) in zip(sigma_strats_test, sigma_strats_test_names)
    ...
    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k0_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    println("Tick")
    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k0_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    println("Tick")
    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k0_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    println("Tick")
    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k0_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    println("Tick")
    run_batch(1000; seed=1234, transition_k=0.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k0_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    println("Tick")

    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k2_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k2_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k2_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k2_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=2.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k2_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))

    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k4_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k4_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k4_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k4_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=4.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k4_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))

    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k7_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k7_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k7_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k7_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=7.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k7_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))

    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=0.5, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k15_sigma0_5.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=1.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k15_sigma1_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=2.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k15_sigma2_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=3.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k15_sigma3_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
    run_batch(1000; seed=1234, transition_k=15.0, noise_sigma=5.0, terrain_value_min=0.0, terrain_value_range=10.0, z_update=24, out_csv="data_large/batch_$(name)_perc_beta0_5_test0_k15_sigma5_0.csv", risk_cfg=RiskConfig(mode=RiskEntropicSigma, beta=0.5, sigma_ref_mode=strat), planner_cfg=PlannerConfig(mode=PlannerGreedyTarget))
end
